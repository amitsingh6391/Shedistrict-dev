...
class BlockConfirmatationPopup extends ConsumerWidget {
  BlockConfirmatationPopup({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context, watch) {
    ...
    return Align(
      ...
      child: Container(
        height: size.height > 570 ? 380 : 420,
        // 350,
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Oh boy, we are sorry that it had to come to this.",
